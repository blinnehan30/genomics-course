...
print(p1)
```
### Faceting can be done to address the overplotting/occlusion in the previous graph
```{r}
...
```
# PCoA/MDS ordination on the bray-curtis distance
```{r}
